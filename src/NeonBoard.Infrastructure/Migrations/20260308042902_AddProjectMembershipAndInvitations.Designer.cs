...
namespace NeonBoard.Infrastructure.Migrations
{
    ...
    [Migration("20260308042902_AddProjectMembershipAndInvitations")]
    partial class AddProjectMembershipAndInvitations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NeonBoard.Domain.Boards.Board", b =>
                {
                    ...
                    b.OwnsMany("NeonBoard.Domain.Boards.Entities.Card", "Cards", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("HoldAt")
                                .HasColumnType("timestamp with time zone");

                            b1.Property<string>("LabelIds")
                                .IsRequired()
                                .HasColumnType("jsonb");
                            ...
                            b1.HasIndex("BoardId", "CardNumber")
                                .IsUnique()
                    ...
                    b.OwnsOne("NeonBoard.Domain.Boards.ValueObjects.BoardPrefix", "Prefix", b1 =>
                        {
                            b1.Property<Guid>("BoardId")
                                .HasColumnType("uuid");
