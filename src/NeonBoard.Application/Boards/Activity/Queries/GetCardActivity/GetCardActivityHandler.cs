...
public class GetCardActivityHandler : IRequestHandler<GetCardActivityQuery, ActivityFeedDto>
{
    private readonly IActivityEntryRepository _activityRepository;
    private readonly IBoardRepository _boardRepository;

    public GetCardActivityHandler(
    ...
    public async Task<ActivityFeedDto> Handle(GetCardActivityQuery request, CancellationToken cancellationToken)
    {
