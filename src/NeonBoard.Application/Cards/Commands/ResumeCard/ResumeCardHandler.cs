...
public class ResumeCardHandler : IRequestHandler<ResumeCardCommand, CardDto>
{
    private readonly IBoardRepository _boardRepository;

    public ResumeCardHandler(IBoardRepository boardRepository)
    {
        _boardRepository = boardRepository;
    }

    public async Task<CardDto> Handle(ResumeCardCommand request, CancellationToken cancellationToken)
    {
        ...
        board.ResumeCard(request.CardId);
