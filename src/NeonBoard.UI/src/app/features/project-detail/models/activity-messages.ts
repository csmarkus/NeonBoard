...
export function getActivityMessage(entry: ActivityEntry): ActivityMessage {
  ...
  switch (entry.actionType) {
    ...
    case 'LabelAdded':
      return { icon: 'tag', text: `Label **${d['labelName']}** added to **${displayId}**`, cardEntityId: entry.entityId, cardDisplayId: displayId };

    case 'LabelRemoved':
      return { icon: 'tag', text: `Label **${d['labelName']}** removed from **${displayId}**`, cardEntityId: entry.entityId, cardDisplayId: displayId };
