...
const mockCards: Card[] = [
  { id: 'card-1', cardNumber: 1, friendlyId: 'TST-1', title: 'Card One', description: '', columnId: 'col-1', position: 0, labels: [], createdAt: '', updatedAt: '' },
  { id: 'card-2', cardNumber: 2, friendlyId: 'TST-2', title: 'Card Two', description: '', columnId: 'col-1', position: 1, labels: [], createdAt: '', updatedAt: '' },
];
